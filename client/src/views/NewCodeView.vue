<template>
  ...
  <h1 class="text-xl">
    ...
    <div class="row-flex bg-white justify-center dev-button">
			<p class="text-xl">
				Expérience : <strong>{{ expData.count }}</strong>
			</p>
			<p class="text-xl">
				<strong>{{ expData.amountSec }}</strong> par seconde et <strong>{{ expData.amount }}</strong> par clic
			</p>
		</div>
  </div>
  ...
  <div class="inline-flex gap-4 pt-4 flex-wrap justify-start">
		<div class="skill-card">
          ...
          <p class="text-sm"><i> Requis pour mission de Niveau 1</i></p>
				</div>
    ...
    <div class="skill-card">
          ...
          <p class="text-sm"><i> Requis pour mission de Niveau 2</i></p>
				</div>
				<div class="inline-flex">
					<button
						@click="addTailwind"
		...
		<div class="skill-card">
			...
			<div class="inline-flex gap-36">
				<div class="row-flex">
					...
					<p class="text-sm"><i> Requis pour mission de Niveau 3</i></p>
				</div>
				<div class="inline-flex">
					<button
						@click="addVite"
