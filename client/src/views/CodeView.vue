...
<template>
	...
	<div class="inline-flex gap-4 pt-4 flex-wrap justify-start">
		...
		<div class="skill-card">
			...
			<div class="inline-flex gap-36">
				<div class="row-flex">
					<p>Coût : {{ tailwindPrice }} exp</p>
					<p>Quantité : {{ tailwind }}</p>
				</div>
				<div class="inline-flex">
					<button
						@click="addTailwind"
